...
2. Royalty Stack - is the percentage of IP revenue that has to be paid to ancestors via Whitelisted/Native royalty policies. External policies do not use royalty stack - only Whitelisted/Native policies use them.
