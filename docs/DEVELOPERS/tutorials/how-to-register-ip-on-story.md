...
<Cards columns={3}>
  <Card title="Completed Code" href="https://github.com/storyprotocol/typescript-tutorial/blob/main/scripts/simpleMintAndRegister.ts" icon="fa-regular fa-thumbs-up" style="color: #63E6BE;" target="_blank">
