...
3. Enter the network details as shown in the image, then click 'Save' to add the network.
   1. Network Name: **Story Odyssey Testnet**
   2. RPC URL: `https://rpc.odyssey.storyrpc.io`
   3. Chain ID: **1516**
   4. Currency Symbol: **IP**
   5. Block Explorer URL: `https://odyssey.storyscan.xyz`
...
<Cards columns={1}>
  <Card title="LayerZero" href="https://docs.layerzero.network/v2/developers/evm/technical-reference/deployed-contracts?chains=odyssey-testnet" icon="fa-home" target="_blank">
...
<Cards columns={3}>
  <Card title="Simplehash" href="https://simplehash.com/" icon="fa-home" target="_blank">
    Instant access to Token and NFT market prices, metadata and media. 80+ chains.
  </Card>

  <Card title="Goldsky" href="https://goldsky.com/" icon="fa-home" target="_blank">
    Crypto Data Live-Streamed.
  </Card>

  <Card title="Zettablock" href="https://zettablock.com/" icon="fa-home" target="_blank">
...
>
> * Try the script yourself and read the code [COMING SOON](https://github.com/storyprotocol/python-sdk/).
